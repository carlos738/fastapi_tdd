...
async def test_usecases_get_should_not_found():
    with pytest.raises(NotFoundException) as err:
        await product_usecase.get(id=UUID("01908154-5a86-700b-b338-3a23d2acef8c"))

    assert (
        err.value.message
        == "Product not found with filter: 01908154-5a86-700b-b338-3a23d2acef8c"
    )
...
async def test_usecases_delete_should_not_found():
    with pytest.raises(NotFoundException) as err:
        await product_usecase.delete(id=UUID("01908154-5a86-700b-b338-3a23d2acef8c"))
